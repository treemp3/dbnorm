...
table_list = ['装备表', '项目表', '摄像头表', '维保计划', '工单表', '工厂表', '供应商分类', '供应商档案',
              ...
              '请购单', '请购单明细', '设计图纸', '出厂资料', '设计BOM', '设计BOM明细', '生产BOM', '作业计划',
              '员工报工时', '报工单', '采购订单', '采购订单明细', '采购到货单', '采购到货单明细',
              '过程检验单', '过程检验单明细', '不合格品', '公司信息', '常见问题', '投诉建议', '装备配件', '产品预订',
              '领料配送单', '领料配送单明细', '配送计划', '配送计划明细', '配送收料记录', '采购到货记录']
template_table = '''
